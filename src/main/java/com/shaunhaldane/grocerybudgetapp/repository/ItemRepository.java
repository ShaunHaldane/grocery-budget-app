package com.shaunhaldane.grocerybudgetapp.repository;
...
import com.shaunhaldane.grocerybudgetapp.DTO.AnnualCostsDTO;
import com.shaunhaldane.grocerybudgetapp.DTO.TotalSpendOnIndividualItemDTO;
import com.shaunhaldane.grocerybudgetapp.entity.Item;
...
public interface ItemRepository extends JpaRepository<Item, Long>{
	...
	@Query("SELECT new com.shaunhaldane.grocerybudgetapp.DTO.AnnualCostsDTO(SUM(i.price), "
	...
	@Query("SELECT new com.shaunhaldane.grocerybudgetapp.DTO.TotalSpendOnIndividualItemDTO(SUM(i.price), "
			+ "i.name) "
			+ "FROM Item i "
			+ "group by i.name")
